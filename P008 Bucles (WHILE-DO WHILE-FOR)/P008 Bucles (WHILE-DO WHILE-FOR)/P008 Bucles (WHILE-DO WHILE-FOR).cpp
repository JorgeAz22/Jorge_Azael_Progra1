...
int main()
{
    ...
    {
        std::cout << "Sal de aquí no tienes la edad para tomar\n";
    }
    
    bool llave1, llave2;
    std::string Cal1 = "Calabozo 1", Cal2 = "Calabozo 2";
    std::cout << "Bienvenido caballero te encontraste con un troll" <<
        " Que haces? 1.- Atacas 0.- Huyes\n";
    std::cin >> llave1;
    if (llave1 == true)
    {
        std::cout << "Que valiente eres acabas de ingresar al " << Cal1 <<
            " Te encontraste con un duende que deseas hacer? \n" <<
            "1.- Atacas 0.- Huyes \n";
        std::cin >> llave2;
        if (llave2 == true)
        {
            std::cout << "Derrotaste al duende y encontraste una princesa" <<
